...
<div class="wa-otp-form wa-otp-modern" data-context="<?php echo esc_attr( $context ); ?>">
	<div class="wa-otp-modern__toggle" data-role="toggle">
		...
		<?php echo esc_html( 'register' === $context ? __( 'Or register with WhatsApp OTP', 'otp-login-by-waloops' ) : __( 'Or log in with WhatsApp OTP', 'otp-login-by-waloops' ) ); ?>
	</div>

	<div class="wa-otp-modern__body" data-role="body" hidden>
		<div class="wa-otp-step" data-step="phone">
			<label class="wa-otp-modern__label" for="wa-otp-phone-<?php echo esc_attr( $context ); ?>"><?php esc_html_e( 'WhatsApp number (with country code)', 'otp-login-by-waloops' ); ?></label>
			...
			<button type="button" class="wa-otp-modern__btn wa-otp-send-btn"><?php esc_html_e( 'Send Code', 'otp-login-by-waloops' ); ?></button>
		</div>

		<div class="wa-otp-step" data-step="code" hidden>
			<label class="wa-otp-modern__label"><?php esc_html_e( 'Enter the 6-digit code', 'otp-login-by-waloops' ); ?></label>
			...
			<button type="button" class="wa-otp-modern__btn wa-otp-verify-btn"><?php esc_html_e( 'Verify & Continue', 'otp-login-by-waloops' ); ?></button>
			<button type="button" class="wa-otp-modern__resend wa-otp-resend-btn"><?php esc_html_e( 'Resend code', 'otp-login-by-waloops' ); ?></button>
		</div>
