...
<div class="wa-otp-form wa-otp-card-style" data-context="<?php echo esc_attr( $context ); ?>">
	<div class="wa-otp-card-style__header">
		...
		<span><?php echo esc_html( 'register' === $context ? __( 'Register with WhatsApp', 'whatsapp-otp-login' ) : __( 'Login with WhatsApp', 'whatsapp-otp-login' ) ); ?></span>
	</div>

	<div class="wa-otp-card-style__body">
		<div class="wa-otp-step" data-step="phone">
			<label class="wa-otp-card-style__label" for="wa-otp-card-phone-<?php echo esc_attr( $context ); ?>"><?php esc_html_e( 'WhatsApp Number', 'whatsapp-otp-login' ); ?></label>
			...
			<button type="button" class="wa-otp-card-style__btn wa-otp-send-btn"><?php esc_html_e( 'Send OTP', 'whatsapp-otp-login' ); ?></button>
		</div>
		<div class="wa-otp-step" data-step="code" hidden>
			<label class="wa-otp-card-style__label"><?php esc_html_e( 'Verification Code', 'whatsapp-otp-login' ); ?></label>
			<input type="text" inputmode="numeric" maxlength="6" class="wa-otp-card-style__input wa-otp-code" placeholder="123456" />
			<button type="button" class="wa-otp-card-style__btn wa-otp-verify-btn"><?php esc_html_e( 'Verify OTP', 'whatsapp-otp-login' ); ?></button>
			<button type="button" class="wa-otp-card-style__resend wa-otp-resend-btn"><?php esc_html_e( 'Didn\'t get it? Resend', 'whatsapp-otp-login' ); ?></button>
		</div>
